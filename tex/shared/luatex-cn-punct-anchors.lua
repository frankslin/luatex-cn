...
--
-- 大陆式：点号字面偏靠（横排左下、直排右上）；台湾式：字面居中。
-- 字体把墨迹画在字幅的哪个位置是字体自己的设计惯例（大陆字体横排形
...
--   大陆式横排：思源宋体（Source Han Serif SC）——GB 惯例左下；
--   大陆式直排：TW-Kai 在旧「经验偏移」实现下的实测落点（该观感已经
...
-- 大陆式直排：点号偏靠右上（贴前字）。x=0.857 见文件头；中点类
