...
### 📰 鲁迅《论辩的魂灵》— 横排现代中文（clreq）

**这个例子展示了什么**
- ➡️ 横排管道 — `luatex-cn-hori` 宏包按 W3C clreq 排版现代中文
- 🀄 台式居中标点 — `style=taiwan` 配 TW-Kai 字体
- 🔗 连续标点缩减 — 嵌套引号（「…『…』…」）连排自动缩为一点五字宽
- 📏 行首行尾标点挤压 — 行末标点半字宽、行首开引号缩减，行行头尾对齐
- 🧱 禁则与孤字 — 行首行尾禁则、段末孤字自动借字，落款右对齐

**[查看源码](./论辩的魂灵/论辩的魂灵.tex)** | **[查看 PDF](./论辩的魂灵/论辩的魂灵.pdf)**
